...
当前调试安装器可从 [GitHub v0.1.0-debug.4 发布页](https://github.com/Eser-s-Organization/ipv6mesh/releases/tag/v0.1.0-debug.4)下载，直接文件地址是 [ipv6mesh-installer-0.1.0-debug.4.exe](https://github.com/Eser-s-Organization/ipv6mesh/releases/download/v0.1.0-debug.4/ipv6mesh-installer-0.1.0-debug.4.exe)。该版本未进行代码签名，首次运行可能出现 SmartScreen 的“未识别发布者”提示；确认下载来源和 SHA-256 后再继续。
